...
describe('#encodeRouteToPath', () => {
  ...
  const pool_0_1_medium = new Pool(token0, token1, FeeAmount.THIRTY, encodeSqrtRatioX96(1, 1), 0, 0, [])
  const pool_1_2_low = new Pool(token1, token2, FeeAmount.FIVE, encodeSqrtRatioX96(1, 1), 0, 0, [])
